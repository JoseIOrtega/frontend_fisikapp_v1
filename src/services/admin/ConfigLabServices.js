...
export const getCategorias = () =>
  fetchGet(API_CONFIG.ENDPOINTS.ADMIN.CATEGORIAS.LIST);
...
export const crearObjetivoGeneral = async (data) => {
  const response = await fetch(
    API_CONFIG.ENDPOINTS.ADMIN.OBJETIVOS_GENERALES.CREATE,
    {
      method: "POST",
      headers: {
...
export const crearObjetivoEspecifico = async (data) => {
  const response = await fetch(
    API_CONFIG.ENDPOINTS.ADMIN.OBJETIVOS_ESPECIFICOS.CREATE,
    {
      method: "POST",
      headers: {
        ...API_CONFIG.getHeaders(),
...
export const getPalabrasClave = () =>
  fetchGet(API_CONFIG.ENDPOINTS.ADMIN.PALABRAS_CLAVE.LIST);

export const crearPalabraClave = async (data) => {
  const response = await fetch(
    API_CONFIG.ENDPOINTS.ADMIN.PALABRAS_CLAVE.CREATE,
    {
      method: "POST",
      headers: {
        ...API_CONFIG.getHeaders(),
...
export const crearLaboratorio = async (formData) => {
