...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    ADMIN: {
      ...
      CREAR_PROFESOR_ESTUDIANTE: `${BASE_URL}/users/crear-profesor/`,
      CARGAR_PROFESORES: `${BASE_URL}/users/usuarios/cargar-profesores/`, // Para crear un usuario como profesor o estudiante
